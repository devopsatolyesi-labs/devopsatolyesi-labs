...
validate:
	...
	helm lint charts/keycloak --set-string postgres.password=test --set-string admin.password=test --set-string users.admin.password=test --set-string users.devops.password=test --set-string users.kubernetes.password=test
