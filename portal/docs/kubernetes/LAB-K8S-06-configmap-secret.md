...
**Not:** `data` altındaki değerlerin Base64 ile encode edildiğini görün. Base64 bir **şifreleme (encryption) değildir**, sadece ikili veriyi metne çevirme formatıdır:
```bash
