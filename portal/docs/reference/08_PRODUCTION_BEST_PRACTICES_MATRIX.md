...
| **5. Değişmez Artifact'lar (Immutability)** | Pinned Git commit SHA veya semantik versiyon (`v1.2.3`), İmzalı imajlar. | Üretimde `:latest` tag kullanmak, mutable image üzerine deploy çıkmak. | Harbor tag retention & immutability kuralları, Cosign | `LAB-DOC-06`, `LAB-JNK-02`, `LAB-GLB-01` |
