...
### Phase 1: CI & Security Gate (CI & Güvenlik Kapısı)
...
### Phase 2: Delivery & GitOps (Kubernetes & GitOps Dağıtımı)
...
### Phase 3: Observability & Feedback (Gözlemlenebilirlik ve Doğrulama)
