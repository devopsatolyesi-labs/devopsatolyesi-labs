...
| :--- | :--- | :--- | :--- |
| 🟢 **CORE** (Temel Seviye) | ⏱️ 40 dakika | `docker` | `8080` |

> [!TIP]
> 📥 **Başlangıç Paketi:** [Bu labın başlangıç paketini indir (LAB-DOC-02.zip)](/downloads/LAB-DOC-02.zip) — paket başlangıç kodlarını içerir; çözüm içermez.
