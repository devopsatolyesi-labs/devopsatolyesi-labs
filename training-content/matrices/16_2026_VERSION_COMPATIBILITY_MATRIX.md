...
| **SonarQube** | [SonarSource](https://www.sonarsource.com/) | Community Build 26.8 | **sonarqube:26.8.0.126808-community** | SonarSource'un takvim sürümleme (YY.MM) standardı. Dahili Java 17, Clean Code ve Jenkins `waitForQualityGate()` ile tam uyumlu. |
